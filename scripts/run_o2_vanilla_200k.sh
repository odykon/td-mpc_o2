...
# Seeds:        1, 2, 3
# Planning:     latent_num_samples=32, latent_num_elites=8, cem_warmstart=true
# Length:       300000 environment steps per task, i.e. train_steps = 300000/action_repeat,
...
#               "300000/${action_repeat}") because train_o2_vanilla.py's load_cfg()
