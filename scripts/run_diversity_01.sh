...
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=cheetah-run     seed=2
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=walker-walk     seed=1
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=walker-walk     seed=2
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=fish-swim       seed=1
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=fish-swim       seed=2
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=cartpole-swingup seed=1
python3 scripts/train_o2_phased.py cfg=cfgs/exp_diversity_01.yaml       task=cartpole-swingup seed=2